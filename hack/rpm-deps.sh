...
LIBVIRT_VERSION=${LIBVIRT_VERSION:-0:10.5.0-5.el9}
QEMU_VERSION=${QEMU_VERSION:-17:9.0.0-10.el9}
SEABIOS_VERSION=${SEABIOS_VERSION:-0:1.16.3-2.el9}
EDK2_VERSION=${EDK2_VERSION:-0:20240524-6.el9}
LIBGUESTFS_VERSION=${LIBGUESTFS_VERSION:-1:1.50.2-1.el9}
GUESTFSTOOLS_VERSION=${GUESTFSTOOLS_VERSION:-0:1.51.6-5.el9}
PASST_VERSION=${PASST_VERSION:-0:0^20240806.gee36266-2.el9}
VIRTIOFSD_VERSION=${VIRTIOFSD_VERSION:-0:1.11.1-1.el9}
