...
var _ = Describe(SIG("Storage", func() {
	...
	Describe("Starting a VirtualMachineInstance", func() {
		...
		Context("with error disk", Serial, func() {
			...
			It("[test_id:storage2]should pause VMI on IO error", func() {
			...
			It("[test_id:jkl][test_id:io3]should report IO errors in the guest with errorPolicy set to report", func() {
		...
		Context("write and read data from a shared disk", func() {
			It("[test_id:storage1]should successfully write and read data", decorators.RequiresBlockStorage, func() {
				const diskName = "disk1"
		...
		Context("with lun disk", Serial, func() {
			...
			DescribeTable("should run the VMI using", func(addLunDisk func(*v1.VirtualMachineInstance, string, string)) {
				...
				Entry("[test_id:storage3]PVC source", addPVCLunDisk),
